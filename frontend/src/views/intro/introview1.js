  ...
  return `
    <div class="js-intro relative min-h-screen overflow-hidden flex items-center justify-center"
      ...
      <div class="js-intro-content relative z-10 text-center px-6 max-w-2xl">
        ...
        <!-- lumiVoice "lesson board": a little app-window card that shows off
             what lumiVoice does, with a mini audio equalizer suggesting it's
             actively reading a lesson out loud -->
        <div class="js-intro-item mb-10">
          <div class="intro-board relative mx-auto max-w-lg text-left rounded-2xl bg-white shadow-2xl overflow-hidden">
          <!-- header bar, like a little app/browser window -->
          <div class="flex items-center gap-2 px-4 py-2.5 bg-gray-50 border-b border-gray-100">
            <span class="w-2.5 h-2.5 rounded-full bg-red-400"></span>
            <span class="w-2.5 h-2.5 rounded-full bg-yellow-400"></span>
            <span class="w-2.5 h-2.5 rounded-full bg-green-400"></span>
            <span class="ml-2 text-xs font-medium text-gray-400">lumiVoice · reading your lesson</span>
          </div>
          <!-- body -->
          <div class="flex items-start gap-3 px-5 py-4">
            <div class="intro-board-mic shrink-0 w-9 h-9 rounded-xl bg-green-600 flex items-center justify-center text-white">
              ${icon.mic}
            </div>
            <div class="flex-1">
              <p class="text-sm sm:text-[15px] text-gray-700 leading-relaxed">
                Learn without limits with courses across every discipline, powered by
                <strong class="text-green-700">lumiVoice</strong>, the AI voice assistant
                that reads and summarizes your lessons.
              </p>
    ...
    <style>
      ...
      @media (prefers-reduced-motion: reduce) {
        .js-intro-item, .intro-pulse, .intro-glow, .intro-board, .intro-board-mic, .intro-eq span { animation: none; opacity: 1; transform: none; }
